...
class DetalheVC: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    var backButton: UIButton = .iconBack(named: "icone-down")
...
//        backButton.addTarget(self, action: #selector(voltarClique), for: .touchUpInside)
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: fotosId, for: indexPath)
 as! DetalhesFotoCell
